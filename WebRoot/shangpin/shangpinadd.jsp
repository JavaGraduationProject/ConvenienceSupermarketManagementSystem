    ...
    <div class="layui-content">
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="spmc" required  lay-verify="required" placeholder="输入商品名称" autocomplete="off" class="layui-input">
                    </div>
					  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="number" name="jg" required  lay-verify="required" placeholder="输入价格" autocomplete="off" class="layui-input">
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="number" name="kc" required value="0"  lay-verify="required" placeholder="输入库存" autocomplete="off" class="layui-input">
                    </div>
                  </div>
