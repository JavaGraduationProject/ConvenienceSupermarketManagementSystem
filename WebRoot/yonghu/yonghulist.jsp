...
<form name="form" action="<%=request.getContextPath()%>/yonghuServlet?method=list" method="post" >
        <div class="layui-row">
                        ...
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="yhm" class="layui-input">
                                </div>
...
rs=(ResultSet)request.getAttribute("rs");
			  ...
			  <td><%=i%></td>
					        ...
					        <td ><%=rs.getString("lxdz")%></td>
					       


<td ><a href="<%=path%>/yonghuServlet?method=delete&keyid=<%=rs.getString("yhid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|<a href="<%=path%>/yonghuServlet?method=modifyindex&keyid=<%=rs.getString("yhid")%>">修改</a>|<a href="<%=path%>/yonghuServlet?method=detail&keyid=<%=rs.getString("yhid")%>">详细</a></td>
