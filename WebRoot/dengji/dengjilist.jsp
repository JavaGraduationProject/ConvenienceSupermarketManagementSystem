    ...
    <div class="layui-content">
        <div class="layui-page-header">
            <div class="pagewrap">
                ...
                <h2 class="title">等级列表</h2>
            </div>
        </div>
	
<form name="form" action="<%=request.getContextPath()%>/dengjiServlet?method=list" method="post" >
        <div class="layui-row">
                        ...
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="dj" class="layui-input">
                                </div>
...
<td ><a href="<%=path%>/dengjiServlet?method=delete&keyid=<%=rs.getString("djid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|<a href="<%=path%>/dengjiServlet?method=modifyindex&keyid=<%=rs.getString("djid")%>">修改</a>|<a href="<%=path%>/dengjiServlet?method=detail&keyid=<%=rs.getString("djid")%>">详细</a></td>
