...
<form name="form" action="<%=request.getContextPath()%>/gysServlet?method=list" method="post" >
        <div class="layui-row">
                        ...
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="gysmc" class="layui-input">
                                </div>
...
rs=(ResultSet)request.getAttribute("rs");
			  ...
			  <td><%=i%></td>
					        ...
					        <td ><%=rs.getString("jyfw")%></td>
					       
					        <td ><%=rs.getString("dj")%></td>
					       


<td ><a href="<%=path%>/gysServlet?method=delete&keyid=<%=rs.getString("gysid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|<a href="<%=path%>/gysServlet?method=modifyindex&keyid=<%=rs.getString("gysid")%>">修改</a>|<a href="<%=path%>/gysServlet?method=detail&keyid=<%=rs.getString("gysid")%>">详细</a></td>
