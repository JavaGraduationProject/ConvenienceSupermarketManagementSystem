    ...
    <div class="layui-content">
        <div class="layui-page-header">
            <div class="pagewrap">
                ...
                <h2 class="title">便利店列表</h2>
            </div>
        </div>
	
<form name="form" action="<%=request.getContextPath()%>/bldServlet?method=list" method="post" >
        <div class="layui-row">
                        ...
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="mc" class="layui-input">
                                </div>
                                <div class="layui-form-mid">地址：</div>
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="dz" class="layui-input">
                                </div>
...
rs=(ResultSet)request.getAttribute("rs");
			  ...
			  <td><%=i%></td>
					        ...
					        <td ><%=rs.getString("dz")%></td>
					       
					        <td ><%=rs.getString("lxdh")%></td>
					       
					        <td ><%=rs.getString("fzr")%></td>
					       


<td ><a href="<%=path%>/bldServlet?method=delete&keyid=<%=rs.getString("bldid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|<a href="<%=path%>/bldServlet?method=modifyindex&keyid=<%=rs.getString("bldid")%>">修改</a>|<a href="<%=path%>/bldServlet?method=detail&keyid=<%=rs.getString("bldid")%>">详细</a></td>
