    ...
    <div class="layui-content">
        <div class="layui-row">
            <div class="layui-card">
                <div class="layui-card-header">修改便利店</div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="mc" required  lay-verify="required" placeholder="输入名称" autocomplete="off" class="layui-input" value="<%=mc%>" >
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="dz" required  lay-verify="required" placeholder="输入地址" autocomplete="off" class="layui-input" value="<%=dz%>" >
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="fzr" required  lay-verify="required" placeholder="输入负责人" autocomplete="off" class="layui-input" value="<%=fzr%>" >
                    </div>
                  </div>
