    ...
    <div class="layui-content">
        <div class="layui-row">
            <div class="layui-card">
                <div class="layui-card-header">修改订单明细</div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="dd" required  lay-verify="required" placeholder="输入订单" autocomplete="off" class="layui-input" value="<%=dd%>" >
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="sl" required  lay-verify="required" placeholder="输入数量" autocomplete="off" class="layui-input" value="<%=sl%>" >
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="jg" required  lay-verify="required" placeholder="输入价格" autocomplete="off" class="layui-input" value="<%=jg%>" >
                    </div>
                  </div>
