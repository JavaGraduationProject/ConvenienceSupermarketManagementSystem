    ...
    <div class="layui-content">
        <div class="layui-page-header">
            <div class="pagewrap">
                ...
                <h2 class="title">订单明细列表</h2>
            </div>
        </div>
	
<form name="form" action="<%=request.getContextPath()%>/ddmxServlet?method=list" method="post" >
        <div class="layui-row">
                        ...
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="dd" class="layui-input">
                                </div>
                                <div class="layui-form-mid">商品：</div>
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="sp" class="layui-input">
                                </div>
...
<td ><a href="<%=path%>/ddmxServlet?method=delete&keyid=<%=rs.getString("ddmxid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|<a href="<%=path%>/ddmxServlet?method=modifyindex&keyid=<%=rs.getString("ddmxid")%>">修改</a>|<a href="<%=path%>/ddmxServlet?method=detail&keyid=<%=rs.getString("ddmxid")%>">详细</a></td>
