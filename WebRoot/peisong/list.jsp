...
<form name="form" action="<%=path%>/peisong/list.jsp" method="post" >
        <div class="layui-row">
...
%>
			...
			<tr class="layui-table-header">
			 ...
			 <TBODY id="table2">			
			  ...
			  <%
			  sql="select * from dingdan  where zt='配送'";
...
<td ><a href="<%=path%>/peisong/peisongadd.jsp?keyid=<%=rs.getString("ddid")%>">配送</a></td>
