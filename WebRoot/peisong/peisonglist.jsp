    ...
    <div class="layui-content">
        <div class="layui-page-header">
            <div class="pagewrap">
                ...
                <h2 class="title">配送列表</h2>
            </div>
        </div>
	
<form name="form" action="<%=request.getContextPath()%>/peisongServlet?method=list" method="post" >
        <div class="layui-row">
                    ...
                    <div class="form-box">
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-form-mid">单号：</div>
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="dh" class="layui-input">
                                </div>
                                <div class="layui-form-mid">出发地：</div>
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="cfd" class="layui-input">
                                </div>
...
<td ><a href="<%=path%>/peisongServlet?method=delete&keyid=<%=rs.getString("psid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|<a href="<%=path%>/peisongServlet?method=modifyindex&keyid=<%=rs.getString("psid")%>">修改</a>|<a href="<%=path%>/peisongServlet?method=detail&keyid=<%=rs.getString("psid")%>">详细</a></td>
