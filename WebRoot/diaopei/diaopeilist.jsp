                    ...
                    <div class="form-box">
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-form-mid">原便利店：</div>
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="ybld" class="layui-input">
                                </div>
...
<td ><a href="<%=path%>/diaopeiServlet?method=detail&keyid=<%=rs.getString("dpid")%>">详细</a></td>
