    ...
    <div class="layui-content">
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="ddh" required  lay-verify="required" placeholder="输入订单号" autocomplete="off" class="layui-input">
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="xdsj" required  lay-verify="required" placeholder="输入下单时间" autocomplete="off" class="layui-input">
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="zjg" required  lay-verify="required" placeholder="输入总价格" autocomplete="off" class="layui-input">
                    </div>
                  </div>
	  ...
	  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="zt" required  lay-verify="required" placeholder="输入状态" autocomplete="off" class="layui-input">
                    </div>
                  </div>
