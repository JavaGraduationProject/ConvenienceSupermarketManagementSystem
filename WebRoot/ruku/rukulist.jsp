    ...
    <div class="layui-content">
        <div class="layui-page-header">
            <div class="pagewrap">
                ...
                <h2 class="title">入库列表</h2>
            </div>
        </div>
	
<form name="form" action="<%=request.getContextPath()%>/rukuServlet?method=list" method="post" >
        <div class="layui-row">
                    ...
                    <div class="form-box">
                        <div class="layui-form layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-form-mid">入库号：</div>
                                <div class="layui-input-inline" style="width: 100px;">
                                  <input type="text" autocomplete="off" name="rkh" class="layui-input">
                                </div>
...
rs=(ResultSet)request.getAttribute("rs");
			  ...
			  <tr align="left">
			  <td><%=i%></td>
					        <td ><%=rs.getString("rkh")%></td>
					       
					        <td ><%=rs.getString("spmc")%></td>
					       
					        <td ><%=rs.getString("bld")%></td>
					       
					        <td ><%=rs.getString("rksl")%></td>
...
<td ><a href="<%=path%>/rukuServlet?method=delete&keyid=<%=rs.getString("rkid")%>"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a></td>
